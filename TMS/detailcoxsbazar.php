    ...
    <div class="selectroom_top">
        <div class="container">
            ...
            <div class="col-md-6 room-midle">
                <h2>Cox's Bazar Holidays - Inani and Himchori Special</h2>
                <p><b>Package Name:</b> Coxs Bazar Holidays</p>
                <p><b>Package Type:</b> Couple Package</p>
                <p><b>Package Location :</b> Coxs Bazar </p>
                <p><b>Features : </b> Free Wi-fi, Free Breakfast, Free Pickup and drop facility </p>


                <input hidden="" type="text" name="useremail" value="kamal@gmail.com">
                <input hidden="" type="text" name="packgeid" value="4">
            ...
            <div>
                ...
                <p>
                    Sea beach visit | Inani beach visit | Himchori special visit | Saint Martin visit | Sunset and sunrise special .
                </p>
            </div>
