    ...
    <div class="selectroom_top">
        <div class="container">
            ...
            <div class="col-md-6 room-midle">
                <h2>Sajek Holidays - Sajek valley and Konglak para Special</h2>
                <p><b>Package Name:</b> Sajek Holidays</p>
                ...
                <input hidden="" type="text" name="useremail" value="riyad@gmail.com">
                <input hidden="" type="text" name="packgeid" value="3">
            ...
            <div>
                ...
                <p>
                    Sajek valley | Konglak para | Halipad Visiting | Sunset and sunrise special
                </p>
            </div>
